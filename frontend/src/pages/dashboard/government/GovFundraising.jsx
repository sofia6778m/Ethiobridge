...
export default function GovFundraising() {
    ...
    <div>
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">Manage your infrastructure fundraising campaigns</p>
        </div>
...
function ReportSelector({ onClose, onSuccess }) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      toast.success('Campaign created from report! Awaiting approval.');
      onSuccess();
    } catch (err) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div onClick={(e) => e.stopPropagation()} className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-5 border-b border-gray-100 dark:border-gray-700">
          <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100">Create Campaign from Infrastructure Report</h2>
        ...
        <div className="p-5">
          {loading ? (
            ...
            <p className="text-center text-gray-400 py-8">No approved infrastructure reports available.</p>
          ) : (
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        ...
                        {r.estimatedCost && ` — Est. cost: ${r.estimatedCost.toLocaleString()} ETB`}
                      </p>
                    </div>
                  </div>
                </div>
...
function CampaignForm({ onClose, onSuccess, editCampaign }) {
  const [form, setForm] = useState({
    ...
    location: {
      region: editCampaign?.location?.region || '',
      city: editCampaign?.location?.city || '',
    },
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <select value={form.campaignType} onChange={(e) => setForm({ ...form, campaignType: e.target.value })} className="input-field text-sm">
