    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <Link
          ...
          className="group border-2 border-amber-200 dark:border-amber-800 bg-amber-50/50 dark:bg-amber-900/10 hover:border-amber-400 hover:shadow-lg rounded-2xl p-6 text-center transition-all duration-200"
        >
          <div className="w-14 h-14 rounded-xl bg-amber-100 dark:bg-amber-900/40 flex items-center justify-center text-3xl mx-auto mb-4 group-hover:scale-110 transition-transform">📋</div>
          <h3 className="font-bold text-gray-900 dark:text-gray-100 text-lg mb-1">Submit Public Complaint</h3>
