...
export default function SubcityAnalytics() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const res = await hierarchyAPI.getSubcityAnalytics();
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-50">Subcity Analytics</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          {data.total} complaint(s) across the subcity
        </p>
      </div>

      <div className="grid md:grid-cols-2 gap-6">
        <div className="card p-5">
          <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-4">Complaints by Status</h3>
        ...
        <div className="card p-5">
          <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-4">Complaints by Department</h3>
          <div className="space-y-3">
