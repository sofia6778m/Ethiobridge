...
const COMPLAINT_SCOPED_ROLES = ['subcity_bole', 'subcity_yeka', 'subcity_lemmi_kura', 'woreda', 'department', 'citizen'];
...
//  - subcity_*        -> complaints whose subcity matches (case-insensitive)
//  - woreda           -> complaints matching their woredaId (no subcity filter)
//  - department       -> complaints matching woredaId + department (case-insensitive)
